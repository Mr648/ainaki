    ...
    <form class="text-center" method="post" action="{{route('signin')}}" id="loginFrom">
        ...
        <div class="form-group text-center">
            ...
            <input type="email" class="form-control ltr" id="loginEmail" placeholder="نام کاربری/ادرس ایمیل/شماره همراه" name="email">
        </div>

        <div class="form-group text-center">
            <label for="pwd">رمز عبور:</label>
            <input type="password" class="form-control" id="loginPwd" placeholder="لطفا رمز عبور خود را وارد کنید" name="pswd">
        </div>
        <div class="form-group form-check text-center">
            <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" id="loginRemember"> مرا به خاطر بسپار
            </label>
        </div>
