<div class="container-fluid mt-2 rtl h-min-768 py-5">
    <div class="row">
        <div class="col-md-3 col-sm-12">
            <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--right w-75" role="navigation">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#mycart" class="nav-link" data-toggle="tab" role="tab" aria-controls="mycart">
                        <i class="fa fa-cart-arrow-down fa-2x icons"></i> سفارش های من </a>
                </li>
                <li class="nav-item">
                    <a href="#changePassword" class="nav-link" role="tab" aria-controls="changePassword">
                        <i class="fa fa-unlock-alt  fa-2x icons"></i> تغییر رمز عبور </a>

                </li>
                <li class="nav-item">
                    <a href="#favorites" class="nav-link" role="tab" aria-controls="favorites">
                        <i class="fa fa-heart  fa-2x icons"></i> لیست علاقه مندی ها</a>
                </li>
                <li class="nav-item">
                    <a href="#messages" class="nav-link" role="tab" aria-controls="messages">
                        <i class="fa fa-envelope fa-2x icons"></i> پیام های من </a>
                </li>
            </ul>
        ...
        <div class="tab-content col-md-9 col-sm-12 w-100">
            ...
            <div class="tab-pane   fade" id="mycart" role="tabpanel">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table w-100" id="tblOrders">
